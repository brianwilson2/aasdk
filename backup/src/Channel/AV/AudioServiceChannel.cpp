...
AudioServiceChannel::AudioServiceChannel(boost::asio::strand<boost::asio::io_context::executor_type>& strand,
...
{
    auto receivePromise = messenger::ReceivePromise::defer(ioService_);
