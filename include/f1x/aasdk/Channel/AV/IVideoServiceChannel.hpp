...
public:
    ...
    virtual void sendVideoFocusIndication(const proto::messages::VideoFocusIndication& indication, messenger::SendPromise::Pointer promise) = 0;
    virtual void sendAVMediaAckIndication(const proto::messages::AVMediaAckIndication& indication, messenger::SendPromise::Pointer promise) = 0;
