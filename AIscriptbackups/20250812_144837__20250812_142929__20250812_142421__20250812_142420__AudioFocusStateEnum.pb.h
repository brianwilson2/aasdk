...
class AudioFocusState final :
 ...
 public:
  ...
  AudioFocusState(AudioFocusState  from);
  AudioFocusState(AudioFocusState&& from) noexcept
    : AudioFocusState() {
    *this = ::std::move(from);
  }

  inline AudioFocusState& operator=(AudioFocusState  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AudioFocusState  default_instance() {
  ...
  inline void CopyFrom(AudioFocusState  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(AudioFocusState  from) {
