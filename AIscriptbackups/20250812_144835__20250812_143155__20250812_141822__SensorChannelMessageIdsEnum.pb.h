...
enum SensorChannelMessage_Enum : int {
  ...
  SensorChannelMessage_Enum_SensorChannelMessage_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  SensorChannelMessage_Enum_SensorChannelMessage_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class SensorChannelMessage final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.ids.SensorChannelMessage) */ {
 public:
  inline SensorChannelMessage() : SensorChannelMessage(nullptr) {}
  explicit PROTOBUF_CONSTEXPR SensorChannelMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SensorChannelMessage(SensorChannelMessage  from);
  SensorChannelMessage(SensorChannelMessage&& from) noexcept
    : SensorChannelMessage() {
    *this = ::std::move(from);
  }

  inline SensorChannelMessage& operator=(SensorChannelMessage  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static SensorChannelMessage  default_instance() {
  ...
  SensorChannelMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SensorChannelMessage>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(SensorChannelMessage  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(SensorChannelMessage  from) {
