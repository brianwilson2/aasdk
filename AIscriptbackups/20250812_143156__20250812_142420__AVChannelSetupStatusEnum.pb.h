...
enum AVChannelSetupStatus_Enum : int {
  ...
  AVChannelSetupStatus_Enum_AVChannelSetupStatus_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  AVChannelSetupStatus_Enum_AVChannelSetupStatus_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool AVChannelSetupStatus_Enum_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, AVChannelSetupStatus_Enum* value) {
...
class AVChannelSetupStatus final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.enums.AVChannelSetupStatus) */ {
 public:
  inline AVChannelSetupStatus() : AVChannelSetupStatus(nullptr) {}
  explicit PROTOBUF_CONSTEXPR AVChannelSetupStatus(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AVChannelSetupStatus(AVChannelSetupStatus  from);
  AVChannelSetupStatus(AVChannelSetupStatus&& from) noexcept
    : AVChannelSetupStatus() {
    *this = ::std::move(from);
  }

  inline AVChannelSetupStatus& operator=(AVChannelSetupStatus  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AVChannelSetupStatus  default_instance() {
  ...
  AVChannelSetupStatus* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AVChannelSetupStatus>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(AVChannelSetupStatus  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(AVChannelSetupStatus  from) {
