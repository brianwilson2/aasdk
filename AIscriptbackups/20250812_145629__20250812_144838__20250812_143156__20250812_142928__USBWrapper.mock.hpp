...
public:
    ...
    MOCK_METHOD2(releaseInterface, int(DeviceHandle  dev_handle, int interface_number));
    MOCK_METHOD1(getDevice, libusb_device*(DeviceHandle  dev_handle));
    MOCK_METHOD2(claimInterface, int(DeviceHandle  dev_handle, int interface_number));
