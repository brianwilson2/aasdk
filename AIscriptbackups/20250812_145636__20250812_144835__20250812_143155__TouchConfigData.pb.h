...
class TouchConfig final :
 ...
 public:
  ...
  TouchConfig(TouchConfig  from);
  TouchConfig(TouchConfig&& from) noexcept
    : TouchConfig() {
    *this = ::std::move(from);
  }

  inline TouchConfig& operator=(TouchConfig  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static TouchConfig  default_instance() {
  ...
  void CopyFrom(TouchConfig  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( TouchConfig  from) {
