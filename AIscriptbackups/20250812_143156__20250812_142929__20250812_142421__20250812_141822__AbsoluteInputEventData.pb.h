...
class AbsoluteInputEvent final :
 ...
 public:
  ...
  AbsoluteInputEvent(AbsoluteInputEvent  from);
  AbsoluteInputEvent(AbsoluteInputEvent&& from) noexcept
    : AbsoluteInputEvent() {
    *this = ::std::move(from);
  }

  inline AbsoluteInputEvent& operator=(AbsoluteInputEvent  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AbsoluteInputEvent  default_instance() {
  ...
  void CopyFrom(AbsoluteInputEvent  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( AbsoluteInputEvent  from) {
