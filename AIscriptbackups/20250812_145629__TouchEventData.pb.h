...
class TouchEvent final :
 ...
 public:
  ...
  TouchEvent(TouchEvent  from);
  TouchEvent(TouchEvent&& from) noexcept
    : TouchEvent() {
    *this = ::std::move(from);
  }

  inline TouchEvent& operator=(TouchEvent  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static TouchEvent  default_instance() {
  ...
  void CopyFrom(TouchEvent  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( TouchEvent  from) {
