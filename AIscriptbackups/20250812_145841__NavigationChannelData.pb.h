...
class NavigationChannel final :
 ...
 public:
  ...
  NavigationChannel(NavigationChannel  from);
  NavigationChannel(NavigationChannel&& from) noexcept
    : NavigationChannel() {
    *this = ::std::move(from);
  }

  inline NavigationChannel& operator=(NavigationChannel  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static NavigationChannel  default_instance() {
  ...
  void CopyFrom(NavigationChannel  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( NavigationChannel  from) {
