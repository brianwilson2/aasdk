...
class AVChannelStopIndication final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.messages.AVChannelStopIndication) */ {
 public:
  inline AVChannelStopIndication() : AVChannelStopIndication(nullptr) {}
  explicit PROTOBUF_CONSTEXPR AVChannelStopIndication(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AVChannelStopIndication(AVChannelStopIndication  from);
  AVChannelStopIndication(AVChannelStopIndication&& from) noexcept
    : AVChannelStopIndication() {
    *this = ::std::move(from);
  }

  inline AVChannelStopIndication& operator=(AVChannelStopIndication  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AVChannelStopIndication  default_instance() {
  ...
  AVChannelStopIndication* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AVChannelStopIndication>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(AVChannelStopIndication  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(AVChannelStopIndication  from) {
