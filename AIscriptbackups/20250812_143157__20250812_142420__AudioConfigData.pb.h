...
class AudioConfig final :
 ...
 public:
  ...
  AudioConfig(AudioConfig  from);
  AudioConfig(AudioConfig&& from) noexcept
    : AudioConfig() {
    *this = ::std::move(from);
  }

  inline AudioConfig& operator=(AudioConfig  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AudioConfig  default_instance() {
  ...
  void CopyFrom(AudioConfig  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( AudioConfig  from) {
