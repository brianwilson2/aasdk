...
class VideoFocusRequest final :
 ...
 public:
  ...
  VideoFocusRequest(VideoFocusRequest  from);
  VideoFocusRequest(VideoFocusRequest&& from) noexcept
    : VideoFocusRequest() {
    *this = ::std::move(from);
  }

  inline VideoFocusRequest& operator=(VideoFocusRequest  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static VideoFocusRequest  default_instance() {
  ...
  void CopyFrom(VideoFocusRequest  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( VideoFocusRequest  from) {
