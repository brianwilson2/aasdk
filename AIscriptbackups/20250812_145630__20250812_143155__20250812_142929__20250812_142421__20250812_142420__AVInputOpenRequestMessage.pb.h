...
class AVInputOpenRequest final :
 ...
 public:
  ...
  AVInputOpenRequest(AVInputOpenRequest  from);
  AVInputOpenRequest(AVInputOpenRequest&& from) noexcept
    : AVInputOpenRequest() {
    *this = ::std::move(from);
  }

  inline AVInputOpenRequest& operator=(AVInputOpenRequest  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AVInputOpenRequest  default_instance() {
  ...
  void CopyFrom(AVInputOpenRequest  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( AVInputOpenRequest  from) {
