...
enum ButtonCode_Enum : int {
  ...
  ButtonCode_Enum_ButtonCode_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ButtonCode_Enum_ButtonCode_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class ButtonCode final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.enums.ButtonCode) */ {
 public:
  inline ButtonCode() : ButtonCode(nullptr) {}
  explicit PROTOBUF_CONSTEXPR ButtonCode(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ButtonCode(ButtonCode  from);
  ButtonCode(ButtonCode&& from) noexcept
    : ButtonCode() {
    *this = ::std::move(from);
  }

  inline ButtonCode& operator=(ButtonCode  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static ButtonCode  default_instance() {
  ...
  ButtonCode* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ButtonCode>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(ButtonCode  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(ButtonCode  from) {
