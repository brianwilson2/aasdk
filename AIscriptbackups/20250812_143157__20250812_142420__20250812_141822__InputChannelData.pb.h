...
class InputChannel final :
 ...
 public:
  ...
  InputChannel(InputChannel  from);
  InputChannel(InputChannel&& from) noexcept
    : InputChannel() {
    *this = ::std::move(from);
  }

  inline InputChannel& operator=(InputChannel  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static InputChannel  default_instance() {
  ...
  void CopyFrom(InputChannel  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( InputChannel  from) {
