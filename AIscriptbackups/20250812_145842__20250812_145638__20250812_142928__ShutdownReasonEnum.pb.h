...
class ShutdownReason final :
 ...
 public:
  ...
  ShutdownReason(ShutdownReason  from);
  ShutdownReason(ShutdownReason&& from) noexcept
    : ShutdownReason() {
    *this = ::std::move(from);
  }

  inline ShutdownReason& operator=(ShutdownReason  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static ShutdownReason  default_instance() {
  ...
  inline void CopyFrom(ShutdownReason  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(ShutdownReason  from) {
