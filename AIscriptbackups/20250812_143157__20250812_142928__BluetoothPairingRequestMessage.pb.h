...
class BluetoothPairingRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR BluetoothPairingRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  BluetoothPairingRequest(BluetoothPairingRequest  from);
  BluetoothPairingRequest(BluetoothPairingRequest&& from) noexcept
    : BluetoothPairingRequest() {
    *this = ::std::move(from);
  }

  inline BluetoothPairingRequest& operator=(BluetoothPairingRequest  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static BluetoothPairingRequest  default_instance() {
  ...
  BluetoothPairingRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<BluetoothPairingRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(BluetoothPairingRequest  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( BluetoothPairingRequest  from) {
...
void BluetoothPairingRequest::set_phone_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.phone_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void BluetoothPairingRequest::_internal_set_phone_address(const std::string& value) {
  ...
  _impl_.phone_address_.Set(value, GetArenaForAllocation());
}
inline std::string* BluetoothPairingRequest::_internal_mutable_phone_address() {
  
  return _impl_.phone_address_.Mutable(GetArenaForAllocation());
}
inline std::string* BluetoothPairingRequest::release_phone_address() {
  ...
  return _impl_.phone_address_.Release();
}
inline void BluetoothPairingRequest::set_allocated_phone_address(std::string* phone_address) {
  ...
  _impl_.phone_address_.SetAllocated(phone_address, GetArenaForAllocation());
...
inline ::f1x::aasdk::proto::enums::BluetoothPairingMethod_Enum BluetoothPairingRequest::_internal_pairing_method() const {
  return static_cast< ::f1x::aasdk::proto::enums::BluetoothPairingMethod_Enum >(_impl_.pairing_method_);
}
