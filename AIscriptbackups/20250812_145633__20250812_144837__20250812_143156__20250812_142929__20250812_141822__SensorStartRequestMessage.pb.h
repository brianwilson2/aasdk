...
class SensorStartRequestMessage final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR SensorStartRequestMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SensorStartRequestMessage(SensorStartRequestMessage  from);
  SensorStartRequestMessage(SensorStartRequestMessage&& from) noexcept
    : SensorStartRequestMessage() {
    *this = ::std::move(from);
  }

  inline SensorStartRequestMessage& operator=(SensorStartRequestMessage  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static SensorStartRequestMessage  default_instance() {
  ...
  SensorStartRequestMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SensorStartRequestMessage>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(SensorStartRequestMessage  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( SensorStartRequestMessage  from) {
    SensorStartRequestMessage::MergeImpl(*this, from);
  }
  private:
...
inline ::f1x::aasdk::proto::enums::SensorType_Enum SensorStartRequestMessage::_internal_sensor_type() const {
  return static_cast< ::f1x::aasdk::proto::enums::SensorType_Enum >(_impl_.sensor_type_);
}
