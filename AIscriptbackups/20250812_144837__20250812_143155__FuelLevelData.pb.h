...
class FuelLevel final :
 ...
 public:
  ...
  FuelLevel(FuelLevel  from);
  FuelLevel(FuelLevel&& from) noexcept
    : FuelLevel() {
    *this = ::std::move(from);
  }

  inline FuelLevel& operator=(FuelLevel  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static FuelLevel  default_instance() {
  ...
  void CopyFrom(FuelLevel  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( FuelLevel  from) {
