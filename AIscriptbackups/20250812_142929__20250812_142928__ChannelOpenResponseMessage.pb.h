...
class ChannelOpenResponse final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ChannelOpenResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ChannelOpenResponse(ChannelOpenResponse  from);
  ChannelOpenResponse(ChannelOpenResponse&& from) noexcept
    : ChannelOpenResponse() {
    *this = ::std::move(from);
  }

  inline ChannelOpenResponse& operator=(ChannelOpenResponse  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static ChannelOpenResponse  default_instance() {
  ...
  ChannelOpenResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ChannelOpenResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(ChannelOpenResponse  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( ChannelOpenResponse  from) {
