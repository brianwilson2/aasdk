...
class ServiceDiscoveryRequest final :
 ...
 public:
  ...
  ServiceDiscoveryRequest(ServiceDiscoveryRequest  from);
  ServiceDiscoveryRequest(ServiceDiscoveryRequest&& from) noexcept
    : ServiceDiscoveryRequest() {
    *this = ::std::move(from);
  }

  inline ServiceDiscoveryRequest& operator=(ServiceDiscoveryRequest  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static ServiceDiscoveryRequest  default_instance() {
  ...
  void CopyFrom(ServiceDiscoveryRequest  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( ServiceDiscoveryRequest  from) {
