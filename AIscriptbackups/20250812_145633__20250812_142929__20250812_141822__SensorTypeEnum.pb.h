...
enum SensorType_Enum : int {
  ...
  SensorType_Enum_SensorType_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  SensorType_Enum_SensorType_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class SensorType final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.enums.SensorType) */ {
 public:
  inline SensorType() : SensorType(nullptr) {}
  explicit PROTOBUF_CONSTEXPR SensorType(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SensorType(SensorType  from);
  SensorType(SensorType&& from) noexcept
    : SensorType() {
    *this = ::std::move(from);
  }

  inline SensorType& operator=(SensorType  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static SensorType  default_instance() {
  ...
  SensorType* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SensorType>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(SensorType  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(SensorType  from) {
