...
class AVStreamType final :
 ...
 public:
  ...
  AVStreamType(AVStreamType  from);
  AVStreamType(AVStreamType&& from) noexcept
    : AVStreamType() {
    *this = ::std::move(from);
  }

  inline AVStreamType& operator=(AVStreamType  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AVStreamType  default_instance() {
  ...
  inline void CopyFrom(AVStreamType  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(AVStreamType  from) {
