...
class AVInputChannel final :
 ...
 public:
  ...
  AVInputChannel(AVInputChannel  from);
  AVInputChannel(AVInputChannel&& from) noexcept
    : AVInputChannel() {
    *this = ::std::move(from);
  }

  inline AVInputChannel& operator=(AVInputChannel  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AVInputChannel  default_instance() {
  ...
  void CopyFrom(AVInputChannel  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( AVInputChannel  from) {
