...
class ButtonEvent final :
 ...
 public:
  ...
  ButtonEvent(ButtonEvent  from);
  ButtonEvent(ButtonEvent&& from) noexcept
    : ButtonEvent() {
    *this = ::std::move(from);
  }

  inline ButtonEvent& operator=(ButtonEvent  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static ButtonEvent  default_instance() {
  ...
  void CopyFrom(ButtonEvent  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( ButtonEvent  from) {
