...
class RelativeInputEvent final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR RelativeInputEvent(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  RelativeInputEvent(RelativeInputEvent  from);
  RelativeInputEvent(RelativeInputEvent&& from) noexcept
    : RelativeInputEvent() {
    *this = ::std::move(from);
  }

  inline RelativeInputEvent& operator=(RelativeInputEvent  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static RelativeInputEvent  default_instance() {
  ...
  RelativeInputEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<RelativeInputEvent>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(RelativeInputEvent  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( RelativeInputEvent  from) {
