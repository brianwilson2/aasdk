...
class VideoConfig final :
 ...
 public:
  ...
  VideoConfig(VideoConfig  from);
  VideoConfig(VideoConfig&& from) noexcept
    : VideoConfig() {
    *this = ::std::move(from);
  }

  inline VideoConfig& operator=(VideoConfig  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static VideoConfig  default_instance() {
  ...
  void CopyFrom(VideoConfig  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( VideoConfig  from) {
