...
class InputEventIndication final :
 ...
 public:
  ...
  InputEventIndication(InputEventIndication  from);
  InputEventIndication(InputEventIndication&& from) noexcept
    : InputEventIndication() {
    *this = ::std::move(from);
  }

  inline InputEventIndication& operator=(InputEventIndication  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static InputEventIndication  default_instance() {
  ...
  void CopyFrom(InputEventIndication  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( InputEventIndication  from) {
