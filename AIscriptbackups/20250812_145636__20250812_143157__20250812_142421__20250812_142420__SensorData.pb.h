...
class Sensor final :
 ...
 public:
  ...
  inline Sensor& operator=(Sensor  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static Sensor  default_instance() {
  ...
  void CopyFrom(Sensor  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( Sensor  from) {
...
inline ::f1x::aasdk::proto::enums::SensorType_Enum Sensor::_internal_type() const {
  return static_cast< ::f1x::aasdk::proto::enums::SensorType_Enum >(_impl_.type_);
}
