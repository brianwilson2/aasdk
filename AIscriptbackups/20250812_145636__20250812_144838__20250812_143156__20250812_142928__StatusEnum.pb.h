...
enum Status_Enum : int {
  Status_Enum_OK = 0,
  Status_Enum_FAIL = 1,
  Status_Enum_Status_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Status_Enum_Status_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class Status final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.enums.Status) */ {
 public:
  ...
  inline Status& operator=(Status  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  inline void CopyFrom(Status  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(Status  from) {
