...
class NavigationFocusRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR NavigationFocusRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  NavigationFocusRequest(NavigationFocusRequest  from);
  NavigationFocusRequest(NavigationFocusRequest&& from) noexcept
    : NavigationFocusRequest() {
    *this = ::std::move(from);
  }

  inline NavigationFocusRequest& operator=(NavigationFocusRequest  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static NavigationFocusRequest  default_instance() {
  ...
  NavigationFocusRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<NavigationFocusRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(NavigationFocusRequest  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( NavigationFocusRequest  from) {
...
inline uint32_t NavigationFocusRequest::_internal_type() const {
  return _impl_.type_;
}
inline uint32_t NavigationFocusRequest::type() const {
  // @@protoc_insertion_point(field_get:f1x.aasdk.proto.messages.NavigationFocusRequest.type)
  return _internal_type();
}
inline void NavigationFocusRequest::_internal_set_type(uint32_t value) {
  
  _impl_.type_ = value;
}
inline void NavigationFocusRequest::set_type(uint32_t value) {
