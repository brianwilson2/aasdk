...
class AudioFocusResponse final :
 ...
 public:
  ...
  AudioFocusResponse(AudioFocusResponse  from);
  AudioFocusResponse(AudioFocusResponse&& from) noexcept
    : AudioFocusResponse() {
    *this = ::std::move(from);
  }

  inline AudioFocusResponse& operator=(AudioFocusResponse  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AudioFocusResponse  default_instance() {
  ...
  void CopyFrom(AudioFocusResponse  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( AudioFocusResponse  from) {
