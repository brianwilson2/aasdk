...
class VideoResolution final :
 ...
 public:
  ...
  VideoResolution(VideoResolution  from);
  VideoResolution(VideoResolution&& from) noexcept
    : VideoResolution() {
    *this = ::std::move(from);
  }

  inline VideoResolution& operator=(VideoResolution  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static VideoResolution  default_instance() {
  ...
  inline void CopyFrom(VideoResolution  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(VideoResolution  from) {
