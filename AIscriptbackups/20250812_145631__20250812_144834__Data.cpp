...
bool DataBuffer::operator==(DataBuffer  buffer) const
{
...
DataConstBuffer::DataConstBuffer(DataBuffer  other)
    : cdata(other.data)
    , size(other.size)
{
}
...
DataConstBuffer::DataConstBuffer(Data  _data, Data::size_type offset)
...
bool DataConstBuffer::operator==(DataConstBuffer  buffer) const
{
