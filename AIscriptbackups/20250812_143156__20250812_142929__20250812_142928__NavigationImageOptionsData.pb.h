...
class NavigationImageOptions final :
 ...
 public:
  ...
  NavigationImageOptions(NavigationImageOptions  from);
  NavigationImageOptions(NavigationImageOptions&& from) noexcept
    : NavigationImageOptions() {
    *this = ::std::move(from);
  }

  inline NavigationImageOptions& operator=(NavigationImageOptions  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static NavigationImageOptions  default_instance() {
  ...
  void CopyFrom(NavigationImageOptions  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( NavigationImageOptions  from) {
