...
class Passenger final :
 ...
 public:
  ...
  ~Passenger() override;
  explicit PROTOBUF_CONSTEXPR Passenger(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  Passenger(Passenger  from);
  Passenger(Passenger&& from) noexcept
    : Passenger() {
    *this = ::std::move(from);
  }

  inline Passenger& operator=(Passenger  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static Passenger  default_instance() {
  ...
  Passenger* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<Passenger>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(Passenger  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( Passenger  from) {
    Passenger::MergeImpl(*this, from);
  }
  private:
