...
class ChannelDescriptor final :
 ...
 public:
  ...
  ChannelDescriptor(ChannelDescriptor  from);
  ChannelDescriptor(ChannelDescriptor&& from) noexcept
    : ChannelDescriptor() {
    *this = ::std::move(from);
  }

  inline ChannelDescriptor& operator=(ChannelDescriptor  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static ChannelDescriptor  default_instance() {
  ...
  void CopyFrom(ChannelDescriptor  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( ChannelDescriptor  from) {
