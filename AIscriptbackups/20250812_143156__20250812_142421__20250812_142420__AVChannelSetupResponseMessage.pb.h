...
class AVChannelSetupResponse final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AVChannelSetupResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AVChannelSetupResponse(AVChannelSetupResponse  from);
  AVChannelSetupResponse(AVChannelSetupResponse&& from) noexcept
    : AVChannelSetupResponse() {
    *this = ::std::move(from);
  }

  inline AVChannelSetupResponse& operator=(AVChannelSetupResponse  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AVChannelSetupResponse  default_instance() {
  ...
  AVChannelSetupResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AVChannelSetupResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(AVChannelSetupResponse  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( AVChannelSetupResponse  from) {
    AVChannelSetupResponse::MergeImpl(*this, from);
  }
  private:
  ...
  void clear_configs();
  private:
  uint32_t _internal_configs(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      _internal_configs() const;
  void _internal_add_configs(uint32_t value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t > configs_;
    int media_status_;
...
inline ::f1x::aasdk::proto::enums::AVChannelSetupStatus_Enum AVChannelSetupResponse::_internal_media_status() const {
  return static_cast< ::f1x::aasdk::proto::enums::AVChannelSetupStatus_Enum >(_impl_.media_status_);
}
...
inline uint32_t AVChannelSetupResponse::_internal_configs(int index) const {
...
inline void AVChannelSetupResponse::set_configs(int index, uint32_t value) {
  _impl_.configs_.Set(index, value);
  // @@protoc_insertion_point(field_set:f1x.aasdk.proto.messages.AVChannelSetupResponse.configs)
}
inline void AVChannelSetupResponse::_internal_add_configs(uint32_t value) {
  _impl_.configs_.Add(value);
}
