...
class PingRequest final :
 ...
 public:
  ...
  PingRequest(PingRequest  from);
  PingRequest(PingRequest&& from) noexcept
    : PingRequest() {
    *this = ::std::move(from);
  }

  inline PingRequest& operator=(PingRequest  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static PingRequest  default_instance() {
  ...
  void CopyFrom(PingRequest  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( PingRequest  from) {
