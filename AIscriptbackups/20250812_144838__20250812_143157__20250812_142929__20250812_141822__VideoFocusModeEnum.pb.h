...
enum VideoFocusMode_Enum : int {
  ...
  VideoFocusMode_Enum_VideoFocusMode_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  VideoFocusMode_Enum_VideoFocusMode_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool VideoFocusMode_Enum_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, VideoFocusMode_Enum* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<VideoFocusMode_Enum>(
    VideoFocusMode_Enum_descriptor(), name, value);
}
// ===================================================================

class VideoFocusMode final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.enums.VideoFocusMode) */ {
 public:
  inline VideoFocusMode() : VideoFocusMode(nullptr) {}
  explicit PROTOBUF_CONSTEXPR VideoFocusMode(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  VideoFocusMode(VideoFocusMode  from);
  VideoFocusMode(VideoFocusMode&& from) noexcept
    : VideoFocusMode() {
    *this = ::std::move(from);
  }

  inline VideoFocusMode& operator=(VideoFocusMode  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static VideoFocusMode  default_instance() {
  ...
  VideoFocusMode* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<VideoFocusMode>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(VideoFocusMode  from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(VideoFocusMode  from) {
