...
class AVChannelStartIndication final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AVChannelStartIndication(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AVChannelStartIndication(AVChannelStartIndication  from);
  AVChannelStartIndication(AVChannelStartIndication&& from) noexcept
    : AVChannelStartIndication() {
    *this = ::std::move(from);
  }

  inline AVChannelStartIndication& operator=(AVChannelStartIndication  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static AVChannelStartIndication  default_instance() {
  ...
  AVChannelStartIndication* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AVChannelStartIndication>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(AVChannelStartIndication  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( AVChannelStartIndication  from) {
    AVChannelStartIndication::MergeImpl(*this, from);
  }
  private:
