...
class Accel final :
 ...
 public:
  ...
  ~Accel() override;
  explicit PROTOBUF_CONSTEXPR Accel(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline Accel& operator=(Accel  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  void CopyFrom(Accel  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( Accel  from) {
