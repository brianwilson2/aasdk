...
class Door final :
 ...
 public:
  ...
  ~Door() override;
  explicit PROTOBUF_CONSTEXPR Door(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline Door& operator=(Door  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  Door* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<Door>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(Door  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( Door  from) {
    Door::MergeImpl(*this, from);
  }
  private:
...
inline bool Door::_internal_door_open(int index) const {
  return _impl_.door_open_.Get(index);
}
