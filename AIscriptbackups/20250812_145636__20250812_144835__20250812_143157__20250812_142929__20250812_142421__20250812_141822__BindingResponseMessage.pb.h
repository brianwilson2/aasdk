...
class BindingResponse final :
 ...
 public:
  ...
  BindingResponse(BindingResponse  from);
  BindingResponse(BindingResponse&& from) noexcept
    : BindingResponse() {
    *this = ::std::move(from);
  }

  inline BindingResponse& operator=(BindingResponse  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static BindingResponse  default_instance() {
  ...
  void CopyFrom(BindingResponse  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( BindingResponse  from) {
