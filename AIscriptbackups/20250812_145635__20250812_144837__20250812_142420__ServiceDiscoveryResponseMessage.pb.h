...
class ServiceDiscoveryResponse final :
 ...
 public:
  ...
  ServiceDiscoveryResponse(ServiceDiscoveryResponse  from);
  ServiceDiscoveryResponse(ServiceDiscoveryResponse&& from) noexcept
    : ServiceDiscoveryResponse() {
    *this = ::std::move(from);
  }

  inline ServiceDiscoveryResponse& operator=(ServiceDiscoveryResponse  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static ServiceDiscoveryResponse  default_instance() {
  ...
  void CopyFrom(ServiceDiscoveryResponse  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( ServiceDiscoveryResponse  from) {
