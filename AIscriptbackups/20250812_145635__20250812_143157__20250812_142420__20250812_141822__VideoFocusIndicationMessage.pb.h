...
class VideoFocusIndication final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR VideoFocusIndication(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  VideoFocusIndication(VideoFocusIndication  from);
  VideoFocusIndication(VideoFocusIndication&& from) noexcept
    : VideoFocusIndication() {
    *this = ::std::move(from);
  }

  inline VideoFocusIndication& operator=(VideoFocusIndication  from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static VideoFocusIndication  default_instance() {
  ...
  VideoFocusIndication* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<VideoFocusIndication>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(VideoFocusIndication  from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( VideoFocusIndication  from) {
    VideoFocusIndication::MergeImpl(*this, from);
  }
  private:
