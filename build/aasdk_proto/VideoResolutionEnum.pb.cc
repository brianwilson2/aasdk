...
static ::_pb::Metadata file_level_metadata_VideoResolutionEnum_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_VideoResolutionEnum_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_VideoResolutionEnum_2eproto = nullptr;

const uint32_t TableStruct_VideoResolutionEnum_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::f1x::aasdk::proto::enums::VideoResolution)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::f1x::aasdk::proto::enums::_VideoResolution_default_instance_._instance,
};
...
const char descriptor_table_protodef_VideoResolutionEnum_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\003b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_VideoResolutionEnum_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_VideoResolutionEnum_2eproto = {
    false, false, 129, descriptor_table_protodef_VideoResolutionEnum_2eproto,
    ...
    file_level_metadata_VideoResolutionEnum_2eproto, file_level_enum_descriptors_VideoResolutionEnum_2eproto,
    file_level_service_descriptors_VideoResolutionEnum_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_VideoResolutionEnum_2eproto_getter() {
  return &descriptor_table_VideoResolutionEnum_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_VideoResolutionEnum_2eproto(&descriptor_table_VideoResolutionEnum_2eproto);
namespace f1x {
namespace aasdk {
namespace proto {
namespace enums {
...
template<> PROTOBUF_NOINLINE ::f1x::aasdk::proto::enums::VideoResolution*
Arena::CreateMaybeMessage< ::f1x::aasdk::proto::enums::VideoResolution >(Arena* arena) {
