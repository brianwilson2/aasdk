...
namespace proto {
namespace enums {
PROTOBUF_CONSTEXPR HeadlightStatus::HeadlightStatus(
    ::_pbi::ConstantInitialized) {}
struct HeadlightStatusDefaultTypeInternal {
  PROTOBUF_CONSTEXPR HeadlightStatusDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 HeadlightStatusDefaultTypeInternal _HeadlightStatus_default_instance_;
}  // namespace enums
}  // namespace proto
}  // namespace aasdk
}  // namespace f1x
static ::_pb::Metadata file_level_metadata_HeadlightStatusEnum_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_HeadlightStatusEnum_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_HeadlightStatusEnum_2eproto = nullptr;
...
static const ::_pb::Message* const file_default_instances[] = {
  &::f1x::aasdk::proto::enums::_HeadlightStatus_default_instance_._instance,
};
...
const char descriptor_table_protodef_HeadlightStatusEnum_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_HeadlightStatusEnum_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_HeadlightStatusEnum_2eproto = {
    false, false, 137, descriptor_table_protodef_HeadlightStatusEnum_2eproto,
    ...
    file_level_metadata_HeadlightStatusEnum_2eproto, file_level_enum_descriptors_HeadlightStatusEnum_2eproto,
    file_level_service_descriptors_HeadlightStatusEnum_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_HeadlightStatusEnum_2eproto_getter() {
  return &descriptor_table_HeadlightStatusEnum_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_HeadlightStatusEnum_2eproto(&descriptor_table_HeadlightStatusEnum_2eproto);
namespace f1x {
namespace aasdk {
namespace proto {
namespace enums {
...
HeadlightStatus::HeadlightStatus(const HeadlightStatus& from)
  ...
  HeadlightStatus* const _this = this; (void)_this;
...
template<> PROTOBUF_NOINLINE ::f1x::aasdk::proto::enums::HeadlightStatus*
Arena::CreateMaybeMessage< ::f1x::aasdk::proto::enums::HeadlightStatus >(Arena* arena) {
