...
namespace proto {
namespace data {
PROTOBUF_CONSTEXPR RelativeInputEvents::RelativeInputEvents(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.relative_input_events_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct RelativeInputEventsDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RelativeInputEventsDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RelativeInputEventsDefaultTypeInternal _RelativeInputEvents_default_instance_;
}  // namespace data
}  // namespace proto
}  // namespace aasdk
}  // namespace f1x
static ::_pb::Metadata file_level_metadata_RelativeInputEventsData_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_RelativeInputEventsData_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_RelativeInputEventsData_2eproto = nullptr;
...
const uint32_t TableStruct_RelativeInputEventsData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::RelativeInputEvents, _impl_.relative_input_events_),
};
...
static const ::_pb::Message* const file_default_instances[] = {
  &::f1x::aasdk::proto::data::_RelativeInputEvents_default_instance_._instance,
};
...
const char descriptor_table_protodef_RelativeInputEventsData_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_RelativeInputEventsData_2eproto_deps[1] = {
  &::descriptor_table_RelativeInputEventData_2eproto,
};
static ::_pbi::once_flag descriptor_table_RelativeInputEventsData_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_RelativeInputEventsData_2eproto = {
    false, false, 187, descriptor_table_protodef_RelativeInputEventsData_2eproto,
    ...
    file_level_metadata_RelativeInputEventsData_2eproto, file_level_enum_descriptors_RelativeInputEventsData_2eproto,
    file_level_service_descriptors_RelativeInputEventsData_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_RelativeInputEventsData_2eproto_getter() {
  return &descriptor_table_RelativeInputEventsData_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_RelativeInputEventsData_2eproto(&descriptor_table_RelativeInputEventsData_2eproto);
namespace f1x {
namespace aasdk {
namespace proto {
namespace data {
...
void RelativeInputEvents::clear_relative_input_events() {
  _impl_.relative_input_events_.Clear();
}
...
RelativeInputEvents::RelativeInputEvents(const RelativeInputEvents& from)
  ...
  RelativeInputEvents* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.relative_input_events_){from._impl_.relative_input_events_}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void RelativeInputEvents::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.relative_input_events_){arena}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void RelativeInputEvents::SharedDtor() {
  ...
  _impl_.relative_input_events_.~RepeatedPtrField();
}
...
const char* RelativeInputEvents::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* RelativeInputEvents::_InternalSerialize(
  ...
  // repeated .f1x.aasdk.proto.data.RelativeInputEvent relative_input_events = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_relative_input_events_size()); i < n; i++) {
    const auto& repfield = this->_internal_relative_input_events(i);
...
// @@protoc_insertion_point(message_byte_size_start:f1x.aasdk.proto.data.RelativeInputEvents)
  ...
  for (const auto& msg : this->_impl_.relative_input_events_) {
    total_size +=
...
void RelativeInputEvents::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RelativeInputEvents*>(&to_msg);
  auto& from = static_cast<const RelativeInputEvents&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:f1x.aasdk.proto.data.RelativeInputEvents)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.relative_input_events_.MergeFrom(from._impl_.relative_input_events_);
...
void RelativeInputEvents::InternalSwap(RelativeInputEvents* other) {
  ...
  _impl_.relative_input_events_.InternalSwap(&other->_impl_.relative_input_events_);
}
...
template<> PROTOBUF_NOINLINE ::f1x::aasdk::proto::data::RelativeInputEvents*
Arena::CreateMaybeMessage< ::f1x::aasdk::proto::data::RelativeInputEvents >(Arena* arena) {
