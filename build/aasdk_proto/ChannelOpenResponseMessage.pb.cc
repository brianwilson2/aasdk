...
static ::_pb::Metadata file_level_metadata_ChannelOpenResponseMessage_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_ChannelOpenResponseMessage_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_ChannelOpenResponseMessage_2eproto = nullptr;

const uint32_t TableStruct_ChannelOpenResponseMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::messages::ChannelOpenResponse, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::messages::ChannelOpenResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::messages::ChannelOpenResponse, _impl_.status_),
  0,
};
...
static const ::_pb::Message* const file_default_instances[] = {
  &::f1x::aasdk::proto::messages::_ChannelOpenResponse_default_instance_._instance,
};
...
const char descriptor_table_protodef_ChannelOpenResponseMessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_ChannelOpenResponseMessage_2eproto_deps[1] = {
  &::descriptor_table_StatusEnum_2eproto,
};
static ::_pbi::once_flag descriptor_table_ChannelOpenResponseMessage_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_ChannelOpenResponseMessage_2eproto = {
    false, false, 153, descriptor_table_protodef_ChannelOpenResponseMessage_2eproto,
    ...
    file_level_metadata_ChannelOpenResponseMessage_2eproto, file_level_enum_descriptors_ChannelOpenResponseMessage_2eproto,
    file_level_service_descriptors_ChannelOpenResponseMessage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_ChannelOpenResponseMessage_2eproto_getter() {
  return &descriptor_table_ChannelOpenResponseMessage_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_ChannelOpenResponseMessage_2eproto(&descriptor_table_ChannelOpenResponseMessage_2eproto);
namespace f1x {
namespace aasdk {
namespace proto {
namespace messages {
...
template<> PROTOBUF_NOINLINE ::f1x::aasdk::proto::messages::ChannelOpenResponse*
Arena::CreateMaybeMessage< ::f1x::aasdk::proto::messages::ChannelOpenResponse >(Arena* arena) {
