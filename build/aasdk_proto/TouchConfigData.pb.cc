...
namespace proto {
namespace data {
PROTOBUF_CONSTEXPR TouchConfig::TouchConfig(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.width_)*/0u
  , /*decltype(_impl_.height_)*/0u
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct TouchConfigDefaultTypeInternal {
  PROTOBUF_CONSTEXPR TouchConfigDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TouchConfigDefaultTypeInternal _TouchConfig_default_instance_;
}  // namespace data
}  // namespace proto
}  // namespace aasdk
}  // namespace f1x
static ::_pb::Metadata file_level_metadata_TouchConfigData_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_TouchConfigData_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_TouchConfigData_2eproto = nullptr;
...
const uint32_t TableStruct_TouchConfigData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::TouchConfig, _impl_.width_),
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::TouchConfig, _impl_.height_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::f1x::aasdk::proto::data::TouchConfig)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::f1x::aasdk::proto::data::_TouchConfig_default_instance_._instance,
};
...
const char descriptor_table_protodef_TouchConfigData_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_TouchConfigData_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_TouchConfigData_2eproto = {
    false, false, 99, descriptor_table_protodef_TouchConfigData_2eproto,
    ...
    file_level_metadata_TouchConfigData_2eproto, file_level_enum_descriptors_TouchConfigData_2eproto,
    file_level_service_descriptors_TouchConfigData_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_TouchConfigData_2eproto_getter() {
  return &descriptor_table_TouchConfigData_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_TouchConfigData_2eproto(&descriptor_table_TouchConfigData_2eproto);
namespace f1x {
namespace aasdk {
namespace proto {
namespace data {
...
TouchConfig::TouchConfig(const TouchConfig& from)
  ...
  TouchConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
const char* TouchConfig::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
void TouchConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<TouchConfig*>(&to_msg);
  auto& from = static_cast<const TouchConfig&>(from_msg);
...
void TouchConfig::InternalSwap(TouchConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TouchConfig, _impl_.height_)
      + sizeof(TouchConfig::_impl_.height_)
      - PROTOBUF_FIELD_OFFSET(TouchConfig, _impl_.width_)>(
...
template<> PROTOBUF_NOINLINE ::f1x::aasdk::proto::data::TouchConfig*
Arena::CreateMaybeMessage< ::f1x::aasdk::proto::data::TouchConfig >(Arena* arena) {
