...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PassengerDefaultTypeInternal _Passenger_default_instance_;
}  // namespace data
}  // namespace proto
}  // namespace aasdk
}  // namespace f1x
static ::_pb::Metadata file_level_metadata_PassengerData_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_PassengerData_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_PassengerData_2eproto = nullptr;
...
const uint32_t TableStruct_PassengerData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::f1x::aasdk::proto::data::Passenger, _impl_.passenger_present_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::f1x::aasdk::proto::data::Passenger)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::f1x::aasdk::proto::data::_Passenger_default_instance_._instance,
};
...
const char descriptor_table_protodef_PassengerData_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001(\010b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_PassengerData_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_PassengerData_2eproto = {
    false, false, 91, descriptor_table_protodef_PassengerData_2eproto,
    "PassengerData.proto",
    ...
    file_level_metadata_PassengerData_2eproto, file_level_enum_descriptors_PassengerData_2eproto,
    file_level_service_descriptors_PassengerData_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_PassengerData_2eproto_getter() {
  return &descriptor_table_PassengerData_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_PassengerData_2eproto(&descriptor_table_PassengerData_2eproto);
namespace f1x {
namespace aasdk {
namespace proto {
namespace data {
...
Passenger::Passenger(const Passenger& from)
  ...
  Passenger* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
const char* Passenger::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* Passenger::_InternalSerialize(
  ...
  // bool passenger_present = 1;
  if (this->_internal_passenger_present() != 0) {
...
void Passenger::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_passenger_present() != 0) {
...
template<> PROTOBUF_NOINLINE ::f1x::aasdk::proto::data::Passenger*
Arena::CreateMaybeMessage< ::f1x::aasdk::proto::data::Passenger >(Arena* arena) {
